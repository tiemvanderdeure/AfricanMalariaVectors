...
module AfricanMalariaVectors
    using CSV, Tables, DataFrames, StatsBase, Statistics
    using Rasters, RasterDataSources, ArchGDAL, NaturalEarth, LibGEOS, Distances
    import MLJBase
    ...
    export load_occurrences, generate_bg, buffer_and_rasterize
